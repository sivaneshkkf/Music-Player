(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function n(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerPolicy&&(a.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?a.credentials="include":e.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(e){if(e.ep)return;e.ep=!0;const a=n(e);fetch(e.href,a)}})();const c=[{songId:1,name:"YongBlood",artist:"Sos",album:"popular",img:"/Music-Player/img/image.png",movieName:"",duration:"3:30"},{songId:2,name:"Shape of You",artist:"Ed Sheeran",album:"popular",img:"/Music-Player/img/singer1.jpg",movieName:"",duration:"3:30"},{songId:3,name:"Let me Love You",artist:"Dj Snake",album:"popular",img:"/Music-Player/img/singer2.jpg",movieName:"",duration:"3:30"},{songId:4,name:"Despacito",artist:"Luis Fonsi, Daddy Yankee",album:"popular",img:"/Music-Player/img/singer3.jpg",movieName:"",duration:"3:30"},{songId:5,name:"Thinking out Loud",artist:"Ed Sheeran",album:"popular",img:"/Music-Player/img/singer4.jpg",movieName:"",duration:"3:30"},{songId:6,name:"Lose Control",artist:"Teddy Swims",album:"popular",img:"/Music-Player/img/song1.PNG",movieName:"",duration:"3:30"},{songId:7,name:"Baby",artist:"Justine biper",album:"topPlayed",img:"/Music-Player/img/singer2.jpg",movieName:"",duration:"3:30"},{songId:8,name:"Rap God",artist:"Eminam",album:"topPlayed",img:"/Music-Player/img/singer3.jpg",movieName:"",duration:"3:30"},{songId:9,name:"Paradise",artist:"Coldplay",album:"topPlayed",img:"/Music-Player/img/singer4.jpg",movieName:"",duration:"3:30"},{songId:10,name:"Youngblood",artist:"Sos",album:"topPlayed",img:"/Music-Player/img/image.png",movieName:"",duration:"3:30"},{songId:11,name:"YongBlood",artist:"Sos",album:"topPlayed",img:"/Music-Player/img/song1.PNG",movieName:"",duration:"3:30"},{songId:12,name:"Shape of You",artist:"Ed Sheeran",album:"topPlayed",img:"/Music-Player/img/song2.PNG",movieName:"",duration:"3:30"},{songId:13,name:"Let me Love You",artist:"Dj Snake",album:"topPlayed",img:"/Music-Player/img/singer2.jpg",movieName:"",duration:"3:30"},{songId:14,name:"Despacito",artist:"Luis Fonsi, Daddy Yankee",album:"topPlayed",img:"/Music-Player/img/singer3.jpg",movieName:"",duration:"3:30"},{songId:15,name:"Thinking out Loud",artist:"Ed Sheeran",album:"topPlayed",img:"/Music-Player/img/singer4.jpg",movieName:"",duration:"3:30"},{songId:16,name:"Lose Control",artist:"Teddy Swims",album:"topPlayed",img:"/Music-Player/img/song1.PNG",movieName:"",duration:"3:30"}],g=new Albums;c.forEach(t=>{const i=new Song(t.songId,t.name,t.artist,t.album,t.img,t.movieName,t.duration);g.pushSong(i)});const r=document.getElementById("pupularUl"),u=document.getElementById("topPlayed");y();function y(){l("popular",r,"popular"),l("topPlayed",u,"topPlayed")}const d=document.getElementById("categoryEl");d.addEventListener("click",t=>{t.target.tagName==="LI"&&([...d.children].forEach(i=>{i.classList.contains("active-li")&&i.classList.remove("active-li")}),t.target.closest("li").classList.add("active-li")),t.target.textContent==="Overview"?l("popular",r,"popular"):t.target.textContent==="Album"?l("topPlayed",r,"popular"):t.target.textContent==="Songs"?l("popular",r,"popular"):l("topPlayed",r,"popular")});function l(t,i,n){const o=document.createDocumentFragment();i.id==="pupularUl"?r.innerHTML="":i.id==="topPlayed"&&(u.innerHTML=""),g.getAlbumSongs(t).forEach((e,a)=>{const s=document.createElement("li");s.innerHTML+=p(n);function p(m){if(m==="popular")return v(e.getId(),e.getImg(),e.getName(),e.getArtist());if(m==="topPlayed")return h(e.getId(),e.getImg(),e.getName(),e.getArtist(),e.getDuration())}s.addEventListener("click",m=>f(e.getId())),o.appendChild(s)}),i.appendChild(o)}function f(t){const i=document.getElementById("psImg"),n=document.getElementById("psName"),o=document.getElementById("psArtist"),e=g.setPlayTrue(t)[0];i.setAttribute("src",e.getImg()),n.textContent=e.getName(),o.textContent=e.getArtist()}function v(t,i,n,o){return`
